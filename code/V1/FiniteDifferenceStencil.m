function W=FiniteDifferenceStencil(h,pts,order)
%Adapted from https://www.mathworks.com/matlabcentral/fileexchange/5269-finite-difference-weights
%Thanks fo Greg von Winckel for this! Modified to give only the centered
%difference weights.
...
%%%%%%%%%%%%%%%%%%%%
centerRow=ceil(pts/2);
W=W(centerRow,:); %Centered difference row
